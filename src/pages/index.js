...
import { setData } from 'store/some/someReducer';
		...
		<>
			...
			<div className={`${styles.page} ${geistSans.variable} ${geistMono.variable}`}>
				<main className={styles.main}>
					...
					<p>{data ? `Datos: ${data}` : 'No hay datos disponibles'}</p>
...
export const getServerSideProps = wrapper.getServerSideProps((store) => async () => {
	...
	// Aquí puedes obtener datos de una API o base de datos
	const fetchedData = `datos cargados desde el servidor: ${data.name}`;

	// Despacha la acción para agregar datos al store
	store.dispatch(setData(fetchedData));

	return {
		props: {}, // Pasamos props vacíos ya que estamos usando Redux para manejar el estado
	};
});
